...
ABC = [cl]
Bots = [mid]
creator = ["u9559e3a9bffe35da21c7fa248d8f5f06"]
owner = ["u9559e3a9bffe35da21c7fa248d8f5f06"]
admin = ["u9559e3a9bffe35da21c7fa248d8f5f06"]
staff = ["u9559e3a9bffe35da21c7fa248d8f5f06"]
Saints = admin + staff
...
settings = {
    ...
    "groupPicture":False,
    "changePicture":False,
    "comment":"╔═════════════════════\n║ 🐯TEAM SOAK KILLER🐯\n║💣OPEN ORDER💣\n╠═════════════════════\n╠➩SELFTBOT ONLY\n╠➩SELFTBOT + ASIST\n╠➩1 AKUN UTAMA    75K\n╠➩1AKUN UTAMA + 2 ASIST 150K\n╠➩1AKUN UTAMA + 3 ASIST 175K\n╠➩1AKUN UTAMA + 4 ASIST 200K\n╠➩1AKUN UTAMA  + 5 ASIST 225K\n╠➩1 AKUN UTAMA + 9 BOT +1 SIRI LUAR 300K\n╠➩ ProtectBot 3-20 Bot Assist\n╠═════════════════════\n║     [👇 Minat Silahan hub👇]\n╠➩line://ti/p/~rozikeane\n╠➩line://ti/p/~Rozikeane\n╠➩line://ti/p/~rozikeane\n╠➩TERIMAKASIH\n║═════════════════════\n╠➩C̽̅̈́̅ŕ̛̋͛e͛̃̾̍ǻ̕͘t͒̉̈̎o͊̓̌͠r̐̇̾̐ B̝̪̭͓͍̺͐͂̑̅̓͗͗̈́͢y͚͔̝͖̮̤͚̅̉̑̐̓̀̋̊͂͜͜͢͞:̶̨̻̪͓̦̻̋̾̂̽̎͘͜͜Roy keane>TͫͪͤͯE͊ͣ̓̕A͛̍̉̉Mͯ͌̍̽ N̓̔E̐ͮͤ̉҉̢̦Wͨͬͨͦ҉̢̨͔̥ ҉̯̖̬̀Ge̶̮̳͕͍̺̼̱͎͛̃̾̍̑̐N̓̔e̶̮̳͕͍̺̼̱͎͛̃̾̍̑̐r̵̺̲̗̩͙̐̇̾̐͐̏̃̓́̊ǻ͕͍̻̭̟̪͒́́̎̕͘̕͟TͫͪͤͯiO̸ͬ̂̀N̓̔҉̣͉S̷͌̋̅༻>\n║ ═════════════════════\n╠➩ Support By: M.Rozikin\n╚══════════════════════",
    ...
    "contents": [
      {
        ...
        "action": {
          "type": "uri",
          "uri": "http://line.me/ti/p/keyla_212"
        },
        "align": "center"
      },
      {
...
def youtubeMp3(to, link):
    ...
    try:
        cl.sendAudio(to, 'Team Bots wiro30_212.mp3')
        time.sleep(2)
        os.remove('Team Bots Janda.mp3')
    except Exception as e:
        cl.sendMessage(to, 'WIRO TEAM BOT\nMungkin Link salah cek lagi coba')
def youtubeMp4(to, link):
    subprocess.getoutput('youtube-dl --format mp4 --output Team Bots Janda.mp4 {}'.format(link))
    try:
        cl.sendVideo(to, "Team Bots wiro_212.mp4")
        time.sleep(2)
        os.remove('Team Bots wiro_212.mp4')
    except Exception as e:
    ...
    if temp_flood != {}:
        for tmp in temp_flood:
            if temp_flood[tmp]["expire"] == True:
                    ...
                    try:
                        veza = "ãBOT ACTIVE AGAINã"
                        cl.sendMessage(tmp, veza, {'AGENT_LINK': "https://line.me/ti/p/~keyla_212", 'AGENT_ICON': "http://klikuntung.com/images/messengers/line-logo.png", 'AGENT_NAME': "Detect Spam "})        
                    except Exception as error:
                        logError(error)    
  ...
  "footer": {
    ...
    "layout": "vertical"
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "u03addfbbbdb20585381383e5d173d28d") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                                    cl.sendMessage(msg.to, None, contentMetadata={'u03addfbbbdb20585381383e5d173d28d': i}, contentType=13)
  ...
  "type": "carousel"
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                sendTextTemplate8(msg.to, "{WIRO_212 BOT}Grup Info\n\n°❂° Nama Group : {}".format(G.name)+ "\n°❂° ID Group : {}".format(G.id)+ "\n°❂° Pembuat : {}".format(G.creator.displayName)+ "\n°❂° Waktu Dibuat : {}".format(str(timeCreated))+ "\n°❂° Jumlah Member : {}".format(str(len(G.members)))+ "\n°❂° Jumlah Pending : {}".format(gPending)+ "\n°❂° Group Qr : {}".format(gQr)+ "\n°❂° Group Ticket : {}".format(gTicket))
